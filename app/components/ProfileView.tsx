        ...
        <>
            ...
            >
                ...
                <View style={styles.hooksContainer}>
                    ...
                    {(userData?.stereotypeTrue || userData?.stereotype_true) && <HookItem title="ЧТО ДЛЯ МЕНЯ ЗНАЧИТ НАСТОЯЩАЯ БЛИЗОСТЬ" text={userData.stereotypeTrue || userData.stereotype_true} color={HOOK_COLORS.stereotypeTrue} icon="heart" />}
                    {(userData?.stereotypeFalse || userData?.stereotype_false) && <HookItem title="ЧЕМ Я ЗАНИМАЮСЬ, КОГДА ХОЧУ ПЕРЕЗАГРУЗИТЬСЯ" text={userData.stereotypeFalse || userData.stereotype_false} color={HOOK_COLORS.stereotypeFalse} icon="refresh" />}
