...
const SLIDES = [
  {
    id: 'welcome',
    title: (name: string) => `Привет, ${name}! Добро пожаловать в Менди :)`,
    topText: 'Мы создали пространство, где тебе будет комфортно искать своих людей',
    bottomText: 'Мы искренне рады, что ты теперь с нами, ведь Менди — это про глубину, а не поверхностное скольжение.',
  },
  {
    id: 'preferences',
    title: () => 'Твои предпочтения — это основа',
    topText: 'В Менди ты не будешь чувствовать себя лишним',
  ...
  },
  {
    ...
    bottomText: 'Начни свой путь в Менди, создай анкету и сплети свою судьбу!',
  },
];
